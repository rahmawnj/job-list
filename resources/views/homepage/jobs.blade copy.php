            ...
            <div class="col-xl-9 col-lg-9 col-md-8">
                ...
                <section class="featured-job-area">
                    <div class="container">
                        ...
                        @foreach (App\Models\Job::latest()->paginate(5) as $job)
                        <div class="single-job-items mb-30">
                            <div class="job-items">
                                <div class="company-img">
                                    <a href="/job/{{$job->id}}"><img height="50" src="{{asset('storage/' . $job->company->logo)}}" alt=""></a>
                                </div>
            ...
            <div class="col-xl-12">
                <div class="single-wrap d-flex justify-content-center">
                    <nav aria-label="Page navigation example">
                        {{App\Models\Job::latest()->paginate(5)->links()}}
                    </nav>
                </div>
            </div>
        </div>
