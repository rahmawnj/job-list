                    ...
                    <form action="/dashboard/users/{{$user->id}}" method="post" enctype="multipart/form-data">
                        ...
                        @csrf
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" id="email" type="text" name="email" value="{{ old('email', $user->email) }}" >
                                @error('email')
                                <span class="text-sm text-danger">
                                    {{$message}}
                                </span>
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" id="password" type="text" name="password" value="{{ old('password') }}" >
                                @error('password')
                                <span class="text-sm text-danger">
                                    {{$message}}
                                </span>
