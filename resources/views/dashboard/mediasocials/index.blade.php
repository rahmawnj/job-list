            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-heading">
                    ...
                    <div class="panel-heading-btn">
                        ...
                        <a href="/dashboard/mediasocials/create" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i></a>
                    </div>
                </div>
                <!-- END panel-heading -->
                <!-- BEGIN alert -->
                    ...
                    <table style="width: 100%;" id="data-table-buttons" class="table table-striped table-bordered align-middle">
                        ...
                        <tbody>
                            ...
                            <tr class="">
                                ...
                                <td class="text-center"> <i class="fa-brands fa-{{$mediasocial->icon}}"></i></td>
                                <td>{{$mediasocial->name}}</td>
                                <td>{{$mediasocial->status}}</td>
                                <td class="">
                                    <a class="btn btn-warning" href="/dashboard/mediasocials/{{$mediasocial->id}}/edit"><i class="fa fa-edit"></i></a>
                                    <a class="d-inline btn btn-info" href="/dashboard/mediasocials/{{$mediasocial->id}}"><i class="fa fa-eye"></i></a>
                                    <form class="d-inline" id="delete-form" action="/dashboard/mediasocials/{{$mediasocial->id}}" method="POST">
                                        @method('delete')
                                        @csrf
