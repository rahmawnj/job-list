            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-heading">
                    ...
                    <div class="panel-heading-btn">
                        ...
                        <a href="/dashboard/companies/create" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i></a>
                    </div>
                </div>
                <!-- END panel-heading -->
                <!-- BEGIN alert -->
                ...
                <div class="panel-body">
                    <table style="width: 100%;" id="data-table-companies" class="table table-striped table-bordered align-middle">
                        <thead>
                            <tr>
                                <th width="1%">No</th>
...
$(function () {
    ...
    var table = $('#data-table-companies').DataTable({
        ...
        columns: [
            ...
            { data: 'name',  name: 'name'  },
            { data: 'email', name: 'email', render: function (d) { return d && String(d).trim() !== '' ? d : '-'; } },
            { data: 'phone', name: 'phone', render: function (d) { return d && String(d).trim() !== '' ? d : '-'; } },
            {
                data: 'jobs_count',
                name: 'jobs_count',
                searchable: false,
    ...
    $('#data-table-companies').on('submit', '.btn-del-form', function (e) {
        e.preventDefault();
        var form = this;
        swal({
            title: "Peringatan!",
