            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-heading">
                    ...
                    <div class="panel-heading-btn">
                        ...
                        <a href="/dashboard/jobcategories/create" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i></a>
                    </div>
                </div>
                <!-- END panel-heading -->
                <!-- BEGIN alert -->
                ...
                <div class="panel-body">
                    <table style="width: 100%;" id="data-table-jobcategories" class="table table-striped table-bordered align-middle">
                        <thead>
                            <tr>
                                <th width="1%">No</th>
                                <th>Name</th>
                                <th class="text-nowrap">slug</th>
                                <th class="text-nowrap">top category</th>
...
$(function () {
    ...
    var table = $('#data-table-jobcategories').DataTable({
        processing: true,
        serverSide: true,
        searching: true,
        ajax: {
            url: '/dashboard/jobcategories',
            type: 'GET',
    ...
    $('#data-table-jobcategories').on('submit', '.btn-del-form', function (e) {
        e.preventDefault();
        var form = this;
        swal({
            title: "Peringatan!",
