                        ...
                        <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control" name="jobcategory_id" id="jobcategory_id">
                                    ...
                                    <option {{ ($jobcategory->id == old('jobcategory_id')) ? 'selected' : '' }} value="{{$jobcategory->id}}">{{$jobcategory->name}}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="number" name="total_position" value="{{ old('total_position') }}" >
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="ckeditor" id="editor1" rows="20" name="description" >{{ old('description') }}</textarea>
                                @error('description')
                                    <span class="text-sm text-danger">
                                        {{$message}}
                                    </span>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="ckeditor" id="editor1" rows="20" name="requirement" rows="5">{{ old('requirement') }}</textarea>
                                @error('requirement')
                                    <span class="text-sm text-danger">
                                        {{$message}}
                                    </span>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control" name="type" id="type">
                                    ...
                                    <option {{ ('full_time' == old('type')) ? 'selected' : '' }} value="full_time">Full Time</option>
                                    <option {{ ('part_time' == old('type')) ? 'selected' : '' }} value="part_time">Part Time</option>
                                    <option {{ ('freelance' == old('type')) ? 'selected' : '' }} value="freelance">Freelance</option>
                                    <option {{ ('remote' == old('type')) ? 'selected' : '' }} value="remote">Remote</option>
                                </select>
                                @error('type')
                                    <span class="text-sm text-danger">
                                        {{$message}}
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control" name="status" id="status">
                                    ...
                                    <option {{ ('active' == old('status')) ? 'selected' : '' }} value="active">Active</option>
                                    <option {{ ('inactive' == old('status')) ? 'selected' : '' }} value="inactive">Inactive</option>
                                </select>
                                @error('status')
                                    <span class="text-sm text-danger">
                                        {{$message}}
