                ...
                <div class="panel-body">
                    <table style="width: 100%;" id="data-table-buttons" class="table table-striped table-bordered align-middle">
                        <thead>
                            <tr>
                                <th width="1%"></th>
                                <th width="1%" data-orderable="false">Job Title</th>
                        ...
                        <tbody>
                            ...
                            <tr class="">
                                ...
                                <td class="">
                                    <a class="d-inline btn btn-info" href="/dashboard/jobs/{{$job->id}}"><i class="fa fa-eye"></i></a>
                                    <form class="d-inline" id="delete-form" action="/dashboard/jobs/delete_dump/{{$job->id}}" method="POST">
                                        @method('delete')
                                        @csrf
                                        <button class="btn-delete border-0  btn btn-danger" type="submit"><i class="fa fa-trash"></i></button>
                                    </form>
                                </td>
                            </tr>
                        @endforeach
