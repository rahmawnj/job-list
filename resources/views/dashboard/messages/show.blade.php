                        	...
                        	<div class="mailbox-content-body">
                                ...
                                <div data-scrollbar="true" data-height="100%" data-skip-mobile="true">
                                    <div class="p-3">
                                        ...
                                        <small class="mb-3">{{$message->email}}</small>
                                        <div class="d-flex mb-3">
                                            ...
                                            <div class="ps-3">
                                                ...
                                                <div class="mb-3px"><i class="fa fa-clock fa-fw"></i> {{\Carbon\Carbon::parse($message->created_at)}}</div>
                                        ...
                                        <form action="/messages/reply_message" method="post">
                                            @csrf
                                            <input type="hidden" value="{{$message->id}}" name="id_message">
                                            <div class="mb-3">
